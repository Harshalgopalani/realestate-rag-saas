...
// This is the fix! Next.js requires the useSearchParams to be inside a Suspense boundary.
export default function Dashboard() {
  return (
    <Suspense fallback={<div className="p-10 text-center text-gray-500">Loading Dashboard Data...</div>}>
      <DashboardContent />
    </Suspense>
  );
}